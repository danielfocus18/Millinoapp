    ...
    <div className="min-h-screen flex" style={{ background: 'var(--surface-base)' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-96 p-10 flex-shrink-0" style={{ background: 'var(--surface-sidebar)' }}>
        ...
        <div>
          ...
          <p style={{ color: '#A8A29E', lineHeight: 1.8, fontSize: '0.9rem' }}>Eatery Point of Sale.<br />Built for speed, designed for simplicity.</p>
          ...
          <div className="mt-10 p-4 rounded-xl" style={{ background: 'rgba(234,88,12,0.12)', border: '1px solid rgba(234,88,12,0.2)' }}>
            ...
            <div className="text-xs space-y-1" style={{ color: '#A8A29E' }}>
              <div>👨‍💼 <strong style={{ color: '#fff' }}>Manager</strong> → Dashboard + Reports + Full Admin</div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 p-4 rounded-xl text-sm" style={{ background: 'var(--brand-cream)', border: '1px solid #FDE68A' }}>
            <div className="font-semibold mb-1" style={{ color: '#92400E' }}>Access levels</div>
            <div style={{ color: '#78350F', fontSize: '0.8rem', lineHeight: 1.7 }}>

...
export default function POSPage() {
  ...
  function addToCart() {
    ...
    addItem({ id: pickedProduct.id, name: pickedProduct.name, sku: pickedProduct.sku, unitPrice: pickedProduct.price, quantity: qty, pricingType, discountPercent, lineTotal })
